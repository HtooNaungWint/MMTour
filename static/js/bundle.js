        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              ...
              window.location.replace('http://localhost:3000/user'); //window.location.reload();
            } else {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              ...
              window.location.replace('http://localhost:3000/login'); //window.location.reload();
            } else {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              (0, _alert.alertElementShow)('success', "Your information has been updated\r\nPlease refresh your page to reflect the updated information"); //window.location.replace('http://localhost:3000/user');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/passwordReset/".concat(token),
              data: {
                password: password,
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              (0, _alert.alertElementShow)('success', "Password is successfully updated, please login again"); //window.location.replace('http://localhost:3000/login');
              //window.location.reload();
            } else {
              (0, _alert.alertElementShow)('error', "welcome ".concat(r.data.message));
            }
