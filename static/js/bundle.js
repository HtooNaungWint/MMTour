      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.alertElementShow)('error', "".concat(_context.t0.response.data.message));
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"logout.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              (0, _alert.alertElementShow)('success', "User is now logged out");
              window.location.replace('/login'); //window.location.reload();
            } else {
              (0, _alert.alertElementShow)('error', "Logout failed");
            }
...
var mapDisplay = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(locations) {
    var map, bounds, maxbounds;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            mapboxgl.accessToken = 'pk.eyJ1IjoiaHRvb25hdW5nIiwiYSI6ImNsNDY3YTZ0bDA1cHYzcG5xaHY0bjhteHkifQ.CDgZ53H3PmoYpsla0gFZeg';
            map = new mapboxgl.Map({
              container: 'map',
              // container ID
              style: 'mapbox://styles/htoonaung/cl467pqys000d14pkjoxewlgh',
              // style URL
            ...
            maxbounds = [[83.670894, 6.103465], // [west, south] 6.103465, 83.670894
...
exports.userUpdate = exports.passwordUpdate = void 0;
...
var userUpdate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, picture) {
    var r;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              (0, _alert.alertElementShow)('success', "Your information has been updated\r\nPlease refresh your page to reflect the updated information"); //window.location.reload();
            } else {
              (0, _alert.alertElementShow)('error', "something went wrong update fail");
            }
  ...
  return function userUpdate(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var passwordUpdate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, newPassword, newPasswordConfirm) {
    var r;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.alertElementShow)('error', "".concat(_context2.t0.response.data.message));
  ...
  return function passwordUpdate(_x4, _x5, _x6) {
...
var passwordReset = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(password, passwordConfirmation, token) {
    var r;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/passwordReset/".concat(token),
              data: {
                password: password,
          ...
          case 3:
            ...
            if (r.data.status === 'success') {
              (0, _alert.alertElementShow)('success', "Password is successfully updated, please login again");
            } else {
              (0, _alert.alertElementShow)('error', "welcome ".concat(r.data.message));
            }
  ...
  return function passwordReset(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51L9FPxCOBO7JoOZFlPhyhQpwklRRFJe3LO9LBvrBoKLmzbdvzn4Gd1Bapu5D4S6e50qEUhMnaeyZHCyTBK3587FH00pS72pcY5');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.alertElementShow)('error', _context.t0);
...
var loginData = document.querySelector('.form__login');
var logoutButton = document.querySelector('.nav__el--logout');
var user = document.querySelector('.form-user-data');
var passwordEle = document.querySelector('.form-user-settings');
var passwordResetEle = document.querySelector('.form__passwordReset');
var bookingEle = document.getElementById('book-tour');
var signupEle = document.querySelector('.form__signup');

if (signupEle) {
  signupEle.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ele) {
      var name, email, password, passwordConfirmation;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
if (user) {
  user.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ele) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              name = document.getElementById('name').value;
              email = document.getElementById('email').value;
              picture = document.getElementById('img').files[0];
              (0, _user.userUpdate)(name, email, picture);
...
if (passwordResetEle) {
  passwordResetEle.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(ele) {
      var password, passwordConfirmation, token;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              (0, _passwordReset.passwordReset)(password, passwordConfirmation, token);
...
if (passwordEle) {
  passwordEle.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(ele) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              newPasswordConfirm = document.getElementById('password-confirm').value; //const picture = document.getElementById('password').value;

              (0, _user.passwordUpdate)(password, newPassword, newPasswordConfirm);
...
if (mapBox) {
  ...
  (0, _mapbox.mapDisplay)(locations);
}

if (bookingEle) {
  bookingEle.addEventListener('click', function (ele) {
    var tourId = ele.target.dataset.tourid;
    (0, _alert.alertElementShow)('info', 'Payment Page is Loading Please Wait...');
...
if (loginData) {
  document.querySelector('.form').addEventListener('submit', /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(ele) {
      var email, password;
